      ...
      <div id="printForm">
        ...
        <div className="c2 border border-2 rounded">
          ...
          >
            ...
            <Form.Item name="other" label="If selected other, Industry Sector:">
            ...
            <Form.Item name="year" label="Required Graduation year">
              <Input disabled={ch === "y"} />
            </Form.Item>
            ...
            <Form.Item label="Mode of Internship?" name="mode">
              <Select
                defaultValue="Select"
                style={{ width: 120 }}
            ...
            <Form.Item label="Internship Duration" name="duration">
              <Select
                mode="multiple"
                allowClear
                style={{ width: "100%" }}
        ...
        <div className="border border-2 rounded c2">
          ...
          <Form
            ...
            <Form.Item name="aname" label="Name">
              <Input disabled={ch === "y"} />
            </Form.Item>
            <Form.Item name="adesignation" label="Designation">
              <Input disabled={ch === "y"} />
            </Form.Item>
            <Form.Item name="aemail" label="Email">
              <Input disabled={ch === "y"} />
            </Form.Item>
            <Form.Item name="aphone" label="Phone Number">
              <Input disabled={ch === "y"} />
            </Form.Item>
            <Form.Item>
        ...
        <div className="border border-2 round c2">
          ...
          <Form
            ...
            <Form.Item name="type_of_test" label="Type of test">
              <Select
                defaultValue="Select"
                style={{ width: 120 }}
                onChange={handleChange}
            ...
            <Form.Item
              name="ppo"
              label="Provision for Pre Placement Offer (PPO)">
              <Select
                defaultValue="Select"
                style={{ width: 120 }}
                onChange={handleChange}
